    ...
    def process_messages(
        ...
        for message in messages:
            ...
            while IMAGE_PLACEHOLDER in content:
                ...
                content = content.replace(
                    IMAGE_PLACEHOLDER,
                    f"<|vision_bos|>{self.image_token * image_seqlen}<|vision_eos|>",
                    1,
                )
                num_image_tokens += 1
            ...
            if (
                ...
                while AUDIO_PLACEHOLDER in content:
                    ...
                    content = content.replace(
                        AUDIO_PLACEHOLDER,
                        f"<|audio_bos|>{self.audio_token * audio_seqlen}<|audio_eos|>",
                        1,
                    )
                    num_audio_tokens += 1
                ...
                while VIDEO_PLACEHOLDER in content:
                    ...
                    content = content.replace(
                        VIDEO_PLACEHOLDER,
                        f"<|vision_bos|>{self.video_token * video_seqlen}<|vision_eos|>",
                        1,
                    )
                    num_video_tokens += 1
